...
import com.numo.wordapp.dto.word.WordDetailMainDto;
import com.numo.wordapp.dto.word.WordDetailSubDto;
...
import com.numo.wordapp.repository.word.SynonymRepository;
import com.numo.wordapp.repository.word.WordDetailMainRepository;
import com.numo.wordapp.repository.word.WordDetailSubRepository;
    ...
    * */
    ...
    public Word updateByWord(WordDto.Request dto, String type){
        ...
        try{
            ...
            // 3. 타입에 알맞는 함수 실행
//            Class c = Class.forName("com.numo.wordapp.service.word.impl.WordServiceImpl");
